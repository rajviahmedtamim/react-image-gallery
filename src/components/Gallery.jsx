...
import GalleryHeader from "./Navabar";
import GalleryImage from "./ImageCard";
import ImageUploader from "./UploadeImage";
...
const Gallery = () => {
  ...
  return (
    <main className="min-h-screen w-screen flex flex-row items-center justify-center p-4">
      <section className="lg:w-[80%] md:w-1/2 w-full bg-white rounded-lg shadow">
